...
export default function App() {
  ...
  const text = ["fills like: ", "humidity:", "wind:", "precipitation:"];
        ...
        "
              ...
              <div className="grid grid-cols-4 gap-4 mt-6">
                {[0, 1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="h-30 rounded-xl bg-[#24243D] animate-pulse flex flex-col gap-4 p-4"
                  >
                    <p>{text[i]}</p>
                  --
                  </div>
              ...
              {/* Daily skeleton */}
              <h2 className="mt-10 mb-4 font-bold">Daily forecast</h2>

              <div className="grid grid-cols-7 gap-4 h-2">
                {[1, 2, 3, 4, 5, 6, 7].map((i) => (
                  <div
                    key={i}
                    className="h-50 rounded-xl bg-[#24243D] animate-pulse"
                  ></div>
                ))}
              </div>
            </>
            ...
            <>
              ...
              <div className="mt-16">
                <h2 className="text-2xl font-bold mb-5">Daily forecast</h2>
